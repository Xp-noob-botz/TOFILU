...
async def gen_link_s(bot, message):
    ...
    if not replied:
        return await message.reply('<b>Send Any File And Reply `/link`</b>')
    ...
    await message.reply(f"<b>⚡ This Is Your Telegram Link\n\n🔗 ᴏʀɪɢɪɴᴀʟ ʟɪɴᴋ :- {share_link}</b>")
...
async def gen_link_batch(bot, message):
    if " " not in message.text:
        return await message.reply("<b>`/batch https://t.me/PandaWep/43 https://t.me/PandaWep/70`</b>")
    ...
    try:
        ...
        return await message.reply('Hay This Channel / Group. Private Make Me An Admin Over There To Index The Files.')
    ...
    if chat_id in FILE_STORE_CHANNEL:
        ...
        await sts.edit(f"<b>⚡ This Is Your Telegram Link\n\n🔗 ᴏʀɪɢɪɴᴀʟ ʟɪɴᴋ :- {share_link}</b>")
        short_link = await get_short_link(user, share_link)
        await message.reply(f"<b>⚡ This Is Your Telegram Link\n\n🖇️ sʜᴏʀᴛ ʟɪɴᴋ :- {short_link}</b>")
        return
